...
const Sidebar = ({ activeSection, onSectionChange, userRole, stats, isOpen, onClose }) => {
            ...
            <div className="px-4 py-3 border-b border-gray-200 bg-gradient-to-br from-red-50 to-red-100">
              ...
              <div className="space-y-2">
                <div 
                  ...
                  onClick={() => { onSectionChange('hospitals'); onClose?.(); }}
                >
                  <div className="flex items-center gap-2">
                ...
                <div 
                  className="flex items-center justify-between p-2 bg-white rounded-lg cursor-pointer hover:bg-red-50 transition-colors"
                  onClick={() => { onSectionChange('ambulances'); onClose?.(); }}
                >
                  <div className="flex items-center gap-2">
                ...
                <div 
                  className="flex items-center justify-between p-2 bg-white rounded-lg cursor-pointer hover:bg-red-50 transition-colors"
                  onClick={() => { onSectionChange('drivers'); onClose?.(); }}
                >
                  <div className="flex items-center gap-2">
                ...
                <div 
                  className="flex items-center justify-between p-2 bg-white rounded-lg cursor-pointer hover:bg-red-50 transition-colors"
                  onClick={() => { onSectionChange('calls'); onClose?.(); }}
                >
                  <div className="flex items-center gap-2">
          ...
          {userRole === 'police' && stats && (
            <div className="px-4 py-3 border-b border-gray-200 bg-gradient-to-br from-red-50 to-red-100">
              ...
              <div className="space-y-2">
                <div 
                  className="flex items-center justify-between p-2 bg-white rounded-lg cursor-pointer hover:bg-red-50 transition-colors"
                  onClick={() => { onSectionChange('dashboard'); onClose?.(); }}
                >
                  <div className="flex items-center gap-2">
